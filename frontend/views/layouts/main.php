...
<svg xmlns="http://www.w3.org/2000/svg" style="display: none">
    <defs>
        <svg id="default-avatar" viewBox="0 0 62 62">
            <path fill="rgba(255, 255, 255, 0.3" d="M0 0h62v62H0V0z"/>
            <path fill="#f0f1f6"
                  d="M60.2 52.9c-1.2-2.1-2.9-3.7-5.1-4.8-3.5-1.8-7.2-3.3-10.9-4.7-1.6-.6-3.2-1.3-4.8-2-.1-.1-.2-.1-.4-.2 1.2-1.8 1.7-3.8 2.4-5.8.1-.2.1-.4.2-.5.2-.6.6-1.1 1.1-1.6 1.9-1.6 3.3-3.6 3.9-6.1.4-1.5.3-3-.7-4.3-.2-.2-.3-.4-.5-.6-.3-.2-.4-.5-.4-.9-.1-2.3-.1-4.5-.3-6.8-.3-3.7-2.5-8.6-8.5-10.3-1.2-.3-2.4-.6-3.7-.6-.1 0-.2 0-.3-.1h-2.3c-.7.1-1.5.2-2.2.3-2.9.5-5.5 1.7-7.5 4-1.6 1.9-2.5 4-2.7 6.4-.2 2.3-.2 4.6-.3 6.9 0 .4-.1.8-.5 1.1-1.1 1-1.4 2.3-1.3 3.7.2 2.2 1.1 4.1 2.6 5.7.5.6 1.1 1.1 1.6 1.6.4.3.7.7.8 1.2.4 1.2.8 2.4 1.2 3.5.3 1 .7 2 1.4 2.8 0 .1.1.1.1.2-.4.2-.7.3-1.1.5-3.2 1.3-6.5 2.6-9.7 4-1.8.8-3.6 1.7-5.4 2.5-2.2 1-3.8 2.6-5 4.7-.8 1.3-1.4 2.6-1.9 4V62h62v-4.3l-.3-.9c-.1-1.3-.7-2.6-1.5-3.9z"/>
        </svg>
    </defs>
</svg>
        ...
        <div class="main-container page-header__container">
            ...
            <div class="account__pop-up">
                <ul class="account__pop-up-list">
                    <li>
                        <a href="<?=Url::to('/tasks/personal')?>">Мои задания</a>
                    </li>
                    <li>
