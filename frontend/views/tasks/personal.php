...
<svg xmlns="http://www.w3.org/2000/svg" style="display: none">
    <defs>
        <svg id="completed" width="20" height="20" viewBox="0 0 20 20"  fill="inherit" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg id="new" width="24" height="24" viewBox="0 0 24 24"  fill="inherit"  xmlns="http://www.w3.org/2000/svg">
        ...
        <svg id="pending" width="21" height="19" viewBox="0 0 21 19" fill="inherit" xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd" clip-rule="evenodd"
        ...
        <svg id="canceled" width="20" height="20" viewBox="0 0 20 20" fill="inherit" xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd" clip-rule="evenodd"
        ...
        <svg id="expired" width="24" height="24" viewBox="0 0 24 24" fill="inherit" xmlns="http://www.w3.org/2000/svg">
...
<section class="menu-toggle">
    ...
    <?php foreach (array_keys(PersonalTasks::FILTERS) as $filter) :?>

    <ul class="menu-toggle__list">
        <li class="menu-toggle__item  <?= $filter === $currentFilter ? ' menu_toggle__item--current ' : ''?>menu-toggle__item--<?=$filter?>">
            <div class="menu-toggle__svg-wrapper">
                <svg><use xlink:href="#<?=$filter?>"/></svg>
            </div>
            <a href="<?= Url::to(['/tasks/personal', 'filter' => $filter]); ?>">
                <?=PersonalTasks::FILTERS[$filter]?>
            </a>
        </li>
    <?php endforeach; ?>
    ...
    <div class="my-list__wrapper">
        ...
        <?php foreach ($tasks->all() as $task): ?>
            ...
            <div class="new-task__card">
                ...
                <div class="<?= "task-status " . strtolower($task->status) . "-status" ?>">
                    <?= TaskStatus::STATUSES[$task->status]?>
                </div>
